...
bot = telebot.TeleBot('6244943702:AAFhwsYkb6FtDAo4N0SgHX84bkypos5WXJ0')
photo_url = 'https://ibb.co/P9WMLfw'
...
def welcome(message):
    ...
    if message.text == '/start':
        ...
        bot.send_message(message.chat.id, f'Привет, {message.from_user.first_name}!\nУ меня ты сможешь купить некоторые товары!\nКонтакт моего разработчика: https://t.me/Freedom1986uz', reply_markup=markup)
    else:
...
def info(message):
    if message.text == '🛍 Товары':
        ...
        webbrowser.open('https://t.me/Freedom1986uz')
